...
class GalacticaPrompter:
	def get_scierc_prompt(self):
		...
		entity_type_q = lambda entity, choices: "Q: Which of the following is the entity type of \"{x}\"? {y}\n\n".format(x=entity, y=choices)
		...
		relation_type_q = lambda e1, e2, choices: "Q: Which of the following is the relation type between \"{x}\" and \"{y}\"? {z}\n\n".format(x=e1, y=e2, z=choices)
